...
This package contains various linting tools combined to make the process of linting a workspace easier. The following packages are included and combined into an easy to use CLI tool:
