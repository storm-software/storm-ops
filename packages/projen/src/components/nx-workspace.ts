...
export class StormNxWorkspace extends NxWorkspace {
   ...
   * @experimental
   */
  public override autoInferProjectTargets: boolean = true;
   ...
   */
  public override extends: string =
    "@storm-software/workspace-tools/config/base.json";
   ...
   * @defaultValue true
   */
  public useDaemonProcess: boolean = true;
   ...
   * @defaultValue true
   */
  public useInferencePlugins: boolean = true;
   ...
   * @defaultValue "main"
   */
  public defaultBase: string = "main";
