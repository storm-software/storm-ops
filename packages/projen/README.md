...
[Projen configuration management package](https://projen.io/) to be used in a
...
Run `nx test projen` to execute the unit tests via [Jest](https://jestjs.io).
