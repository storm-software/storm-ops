...
# Storm Software's Conventional Changelog Package

This package contains the shared
[conventional-changelog](https://github.com/conventional-changelog/conventional-changelog)
configuration used in Storm Software projects.
...
```bash
pnpm add -D conventional-changelog-storm-software
```
...
```bash
npm install -D conventional-changelog-storm-software
```
...
```bash
yarn add -D conventional-changelog-storm-software
```
