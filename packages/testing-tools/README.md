...
[![Version](https://img.shields.io/badge/version-1.33.14-1fb2a6.svg?style=for-the-badge&color=1fb2a6)](https://prettier.io/)&nbsp;
...
```bash
pnpm add -D @storm-software/testing-tools
```
...
```bash
npm install -D @storm-software/testing-tools
```
...
```bash
yarn add -D @storm-software/testing-tools
```
