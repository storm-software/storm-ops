...
export const getLogFn = (
  ...
  if (
    ...
    return (message?: any) => {
      console.error(
        `
${_chalk.gray(formatTimestamp())} ${_chalk.bold.hex(colors.fatal ?? "#7d1a1a")(`[${CONSOLE_ICONS[LogLevelLabel.FATAL]} Fatal]`)} ${_chalk.bold.whiteBright(formatLogMessage(message))}
`
      );
    };
  }
  ...
  if (
    ...
    return (message?: any) => {
      console.error(
        `
${_chalk.gray(formatTimestamp())} ${_chalk.bold.hex(colors.danger ?? "#f85149")(`[${CONSOLE_ICONS[LogLevelLabel.ERROR]} Error]`)} ${_chalk.bold.whiteBright(formatLogMessage(message))}
`
      );
    };
  }
  ...
  if (
    ...
    return (message?: any) => {
      console.warn(
        `
${_chalk.gray(formatTimestamp())} ${_chalk.bold.hex(colors.warning ?? "#e3b341")(`[${CONSOLE_ICONS[LogLevelLabel.WARN]} Warn]`)} ${_chalk.bold.whiteBright(formatLogMessage(message))}
`
      );
    };
  }
  ...
  if (
    ...
    return (message?: any) => {
      console.info(
        `
${_chalk.gray(formatTimestamp())} ${_chalk.bold.hex(colors.success ?? "#56d364")(`[${CONSOLE_ICONS[LogLevelLabel.SUCCESS]} Success]`)} ${_chalk.bold.whiteBright(formatLogMessage(message))}
`
      );
    };
  }
  ...
  if (
    ...
    return (message?: any) => {
      console.info(
        `
${_chalk.gray(formatTimestamp())} ${_chalk.bold.hex(colors.info ?? "#58a6ff")(`[${CONSOLE_ICONS[LogLevelLabel.INFO]} Info]`)} ${_chalk.bold.whiteBright(formatLogMessage(message))}
`
      );
    };
  }
  ...
  if (
    ...
    return (message?: any) => {
      console.debug(
        `
${_chalk.gray(formatTimestamp())} ${_chalk.bold.hex(colors.brand ?? "#1fb2a6")(`[${CONSOLE_ICONS[LogLevelLabel.TRACE]} Debug]`)} ${_chalk.bold.whiteBright(formatLogMessage(message))}
`
      );
    };
  }
  ...
  return (message?: any) => {
    console.log(
      `
${_chalk.gray(formatTimestamp())} ${_chalk.bold.hex(colors.brand ?? "#1fb2a6")(`[${CONSOLE_ICONS[LogLevelLabel.ALL]}  System]`)} ${_chalk.bold.whiteBright(formatLogMessage(message))}
`
    );
  };
};
