...
- **workspace-tools:** Added the `rollup` executor ([efcbbc60](https://github.com/storm-software/storm-ops/commit/efcbbc60))
...
- **workspace-tools:** Ensure the correct version of the rollup plugin is installed ([7b344f6a](https://github.com/storm-software/storm-ops/commit/7b344f6a))

- **workspace-tools:** Resolve typing issue in option defaulting ([ec7152bf](https://github.com/storm-software/storm-ops/commit/ec7152bf))
