...
- [Storm ESLint Configuration Package](#storm-eslint-configuration-package)
...
# Storm ESLint Configuration Package

This package contains a shared ESLint configuration used across the Storm
Software organization. This configuration is used to enforce code quality and
style standards across all Storm Software projects.
