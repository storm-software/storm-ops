...
# Storm Base ESLint Package

This package contains the base ESLint configurations used across the Storm
Software organization and in the organizations's ESLint Plugin package. This
...
```bash
pnpm add -D @storm-software/eslint
```
...
```bash
npm install -D @storm-software/eslint
```
...
```bash
yarn add -D @storm-software/eslint
```
