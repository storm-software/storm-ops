...
> This rule is a wrapper around a `graphql-js` validation function.
   ...
   * @see https://github.com/nrwl/nx/blob/22.7.1/docs/generated/packages/eslint-plugin/documents/dependency-checks.md
   */
  '@nx/dependency-checks'?: Linter.RuleEntry<NxDependencyChecks>
  /**
   * Ensure that module boundaries are respected within the monorepo
   * @see https://github.com/nrwl/nx/blob/22.7.1/docs/generated/packages/eslint-plugin/documents/enforce-module-boundaries.md
   */
