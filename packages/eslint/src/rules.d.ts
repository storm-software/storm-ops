...
export interface RuleOptions {
   ...
   * @see https://github.com/nrwl/nx/blob/19.6.2/docs/generated/packages/eslint-plugin/documents/dependency-checks.md
   */
  '@nx/dependency-checks'?: Linter.RuleEntry<NxDependencyChecks>
  /**
   * Ensure that module boundaries are respected within the monorepo
   * @see https://github.com/nrwl/nx/blob/19.6.2/docs/generated/packages/eslint-plugin/documents/enforce-module-boundaries.md
   */
