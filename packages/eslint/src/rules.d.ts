...
// ----- json/* -----
// ----- json/colon-expected -----
type JsonColonExpected = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/comma-expected -----
type JsonCommaExpected = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/comma-or-close-backet-expected -----
type JsonCommaOrCloseBacketExpected = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/comma-or-close-brace-expected -----
type JsonCommaOrCloseBraceExpected = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/comment-not-permitted -----
type JsonCommentNotPermitted = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/duplicate-key -----
type JsonDuplicateKey = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/enum-value-mismatch -----
type JsonEnumValueMismatch = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/invalid-character -----
type JsonInvalidCharacter = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/invalid-escape-character -----
type JsonInvalidEscapeCharacter = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/invalid-unicode -----
type JsonInvalidUnicode = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/json -----
type JsonJson = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/property-expected -----
type JsonPropertyExpected = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/schema-resolve-error -----
type JsonSchemaResolveError = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/trailing-comma -----
type JsonTrailingComma = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/undefined -----
type JsonUndefined = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/unexpected-end-of-comment -----
type JsonUnexpectedEndOfComment = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/unexpected-end-of-number -----
type JsonUnexpectedEndOfNumber = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/unexpected-end-of-string -----
type JsonUnexpectedEndOfString = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/unknown -----
type JsonUnknown = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- json/value-expected -----
type JsonValueExpected = []|[("allowComments" | {
  allowComments?: boolean
})]
// ----- prettier/prettier -----
