...
[![Version](https://img.shields.io/badge/version-0.0.14-1fb2a6.svg?style=for-the-badge&color=1fb2a6)](https://prettier.io/)&nbsp;
...
```bash
pnpm add -D @storm-software/tsconfig
```
...
```bash
npm install -D @storm-software/tsconfig
```
...
```bash
yarn add -D @storm-software/tsconfig
```
