...
import { isCallOrNewExpression, isMethodCall } from "./ast/index";
import { getVariableIdentifiers } from "./utils/index";
...
const create = context => ({
  Identifier(node) {
    ...
    // This was reported https://github.com/storm-software/storm-ops/issues/1075#issuecomment-768073342
