import isNewExpressionWithParentheses from "./is-new-expression-with-parentheses";
import { isDecimalIntegerNode } from "./numeric";
...
@returns {boolean}
*/
export function shouldAddParenthesesToMemberExpressionObject(node, sourceCode) {
  switch (node.type) {
...
export default shouldAddParenthesesToMemberExpressionObject;
