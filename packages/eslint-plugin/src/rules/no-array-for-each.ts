...
import assertToken from "./utils/assert-token";
import isFunctionSelfUsedInside from "./utils/is-function-self-used-inside";
import { isNodeMatches } from "./utils/is-node-matches";
import needsSemicolon from "./utils/needs-semicolon";
import { getParentheses, getParenthesizedRange } from "./utils/parentheses";
import shouldAddParenthesesToExpressionStatementExpression from "./utils/should-add-parentheses-to-expression-statement-expression";
import shouldAddParenthesesToMemberExpressionObject from "./utils/should-add-parentheses-to-member-expression-object";
...
function isFixable(
  ...
  if (
    ...
    // https://github.com/storm-software/storm-ops/issues/1814
