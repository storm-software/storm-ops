import { isFunction, isMethodCall } from "./ast/index";
import { getParenthesizedRange } from "./utils/index";
...
const create = context => {
  ...
  return {
    CallExpression(callExpression) {
      ...
      const { functionNode, isInTryStatement } =
        getFunctionNode(callExpression);
      if (
        !functionNode ||
