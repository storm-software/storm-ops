import isNewExpressionWithParentheses from "../utils/is-new-expression-with-parentheses";
...
import removeSpaceAfter from "./remove-spaces-after";

export function* switchNewExpressionToCallExpression(
  newExpression,
  sourceCode,
  fixer
) {
...
export default switchNewExpressionToCallExpression;
