...
import { isStaticRequire } from "./ast";
import { renameVariable } from "./fix";
import {
  defaultAllowList,
  defaultIgnore,
  defaultReplacements
} from "./shared/abbreviations";
    ...
    replacements: new Map(
      Object.entries(mergedReplacements).map(
        ([discouragedName, replacements]) => [
          discouragedName,
          new Map(Object.entries(replacements as any))
        ]
      )
    ),
