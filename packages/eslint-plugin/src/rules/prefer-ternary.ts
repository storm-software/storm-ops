...
import { extendFixRange } from "./fix/index";
import avoidCapture from "./utils/avoid-capture";
import getIndentString from "./utils/get-indent-string";
...
import { getParenthesizedText } from "./utils/parentheses";
import shouldAddParenthesesToConditionalExpressionChild from "./utils/should-add-parentheses-to-conditional-expression-child";
