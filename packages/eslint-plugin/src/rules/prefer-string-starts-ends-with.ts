...
import { isMethodCall, isRegexLiteral } from "./ast/index";
import escapeString from "./utils/escape-string";
import {
  getParenthesizedRange,
  getParenthesizedText
} from "./utils/parentheses";
import shouldAddParenthesesToLogicalExpressionChild from "./utils/should-add-parentheses-to-logical-expression-child";
