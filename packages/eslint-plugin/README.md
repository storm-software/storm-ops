...
[![Version](https://img.shields.io/badge/version-0.3.2-1fb2a6.svg?style=for-the-badge&color=1fb2a6)](https://prettier.io/)&nbsp;
...
# Storm ESLint Plugin Package

This package contains the Storm Software ESLint plugin. This plugin is used to
enforce code quality and style standards across all Storm Software projects.
...
Run `nx test eslint-plugin` to execute the unit tests via
