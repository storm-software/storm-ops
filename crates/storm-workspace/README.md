...
# Storm Workspace Management Crate

A crate containing various utilities and tools used by Storm Software to manage
monorepos.
...
```bash
cargo add -D storm-workspace
```

## Building

Run `nx build storm-workspace` to build the crate.

## Running unit tests

Run `nx test storm-workspace` to execute the unit tests via
