...
A crate containing the configuration structure and utilities used by Storm
Software monorepos.
...
Run `nx test storm-config` to execute the unit tests via
