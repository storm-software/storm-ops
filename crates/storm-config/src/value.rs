...
impl Value {
  ...
  where
    V: Into<ValueKind>,
  {
    Self { origin: origin.cloned(), kind: kind.into() }
  }
  ...
  pub fn into_bool(self) -> Result<bool> {
    match self.kind {
      ...
      // Unexpected type
      ValueKind::Nil => Err(ConfigError::invalid_type(self.origin, Unexpected::Unit, "a boolean")),
      ValueKind::Table(_) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::Map, "a boolean"))
      }
      ValueKind::Array(_) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::Seq, "a boolean"))
      }
    }
  }
  ...
  pub fn into_int(self) -> Result<i64> {
    match self.kind {
      ...
      // Unexpected type
      ValueKind::Nil => Err(ConfigError::invalid_type(self.origin, Unexpected::Unit, "an integer")),
      ValueKind::Table(_) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::Map, "an integer"))
      }
      ValueKind::Array(_) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::Seq, "an integer"))
      }
    }
  }
  ...
  pub fn into_int128(self) -> Result<i128> {
    match self.kind {
      ...
      ValueKind::U128(value) => value.try_into().map_err(|_| {
        ConfigError::invalid_type(self.origin, Unexpected::U128(value), "an signed 128 bit integer")
      }),
  ...
  pub fn into_float(self) -> Result<f64> {
    match self.kind {
      ...
      // Unexpected type
      ValueKind::Nil => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::Unit, "a floating point"))
      }
      ValueKind::Table(_) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::Map, "a floating point"))
      }
      ValueKind::Array(_) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::Seq, "a floating point"))
      }
    }
  }
  ...
  pub fn into_array(self) -> Result<Vec<Self>> {
    match self.kind {
      ...
      ValueKind::I64(value) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::I64(value), "an array"))
      }
      ValueKind::I128(value) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::I128(value), "an array"))
      }
      ValueKind::U64(value) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::U64(value), "an array"))
      }
      ValueKind::U128(value) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::U128(value), "an array"))
      }
  ...
  pub fn into_table(self) -> Result<Map<String, Self>> {
    match self.kind {
      ...
      ValueKind::I64(value) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::I64(value), "a map"))
      }
      ValueKind::I128(value) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::I128(value), "a map"))
      }
      ValueKind::U64(value) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::U64(value), "a map"))
      }
      ValueKind::U128(value) => {
        Err(ConfigError::invalid_type(self.origin, Unexpected::U128(value), "a map"))
      }
      ValueKind::Boolean(value) => {
    ...
    D: Deserializer<'de>,
  {
    ...
    impl<'de> Visitor<'de> for ValueVisitor {
        ...
        E: ::serde::de::Error,
      {
        let num: i64 = value
          .try_into()
          .map_err(|_| E::invalid_type(::serde::de::Unexpected::Unsigned(value), &self))?;
        Ok(num.into())
      }
        ...
        E: ::serde::de::Error,
      {
        let num: i128 = value.try_into().map_err(|_| {
          E::invalid_type(
            ::serde::de::Unexpected::Other(format!("integer `{}` as u128", value).as_str()),
            &self,
          )
        })?;
        Ok(num.into())
  ...
  T: Into<ValueKind>,
{
  fn from(value: T) -> Self {
    Self { origin: None, kind: value.into() }
  }
}
...
mod tests {
  ...
  fn test_i64() {
    ...
    assert!(std::matches!(value.kind, ValueKind::I64(120)), "Is not a i64(120): {:?}", value.kind);
  }
}
